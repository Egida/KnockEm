#!/usr/bin/env python3
# THIS IS GOLDENEYE MODIFIED BY ME
# THIS IS GOLDENEYE MODIFIED BY ME
# THIS IS GOLDENEYE MODIFIED BY ME
# THIS IS GOLDENEYE MODIFIED BY ME
# THIS IS GOLDENEYE MODIFIED BY ME
...
# THIS IS GOLDENEYE MODIFIED BY ME
# THIS IS GOLDENEYE MODIFIED BY ME
# user agent spooof bypasses a lot of nginx stuff
"""
$Id: $
...
class GoldenEye(object):
    ...
    def exit(self):
        self.stats()
        print("Shutting down NginxBypass")
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} NginxBypass strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
...
class Striker(Process):
    ...
    def run(self):
        ...
        if DEBUG:
            print("Bots made ==> {0}".format(self.name))
...
def usage():
    ...
    print(GOLDENEYE_BANNER)
    print()
    print(' USAGE: ./NginxBypass.py <url> [OPTIONS]')
    print()
    print(' OPTIONS:')
